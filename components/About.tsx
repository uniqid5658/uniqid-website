        ...
        <div className="flex flex-col md:flex-row items-center gap-16">
          ...
          <div className="w-full md:w-1/2 order-2 md:order-1">
            ...
            <div className="space-y-6 text-stone-600 leading-relaxed">
              ...
              <p>
                We offer the perfect partnership for architects and clients who care about the details. We speak your language, we respect your materials, and we build with understanding.
              </p>
